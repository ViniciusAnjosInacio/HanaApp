sap.ui.define(
  ...
  function (BaseController, MessageToast, MessageBox, Sorter, Filter, FilterOperator, FilterType, JSONModel) {
    ...
    return BaseController.extend("valefuncionarioscrud.controller.App", {
      ...
      onCreate : function () {
        var oList = this.byId("_IDGenTable1"),
      ...
      onResetChanges : function () {
        this.byId("_IDGenTable1").getBinding("items").resetChanges();
        this._bTechnicalErrors = false; 
      ...
      onSearch: function () {
        ...
        oView.byId("_IDGenTable1").getBinding("items").filter(oFilter, FilterType.Application);
      },
      ...
      onSort: function () {
        ...
        oView.byId("_IDGenTable1").getBinding("items").sort(sOrder && new Sorter("Nome", sOrder === "desc"));
